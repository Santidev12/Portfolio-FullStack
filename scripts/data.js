  ...
  skills: [
    {
      name: "HTML",
      description:
        "HTML es un lenguaje de marcado de etiquetas que se utiliza para crear y estructurar contenido en la web. Este lenguaje permite definir la estructura y el contenido de una página web mediante etiquetas y atributos que indican al navegador cómo mostrar la información.",
    },
    {
      name: "CSS",
      description:
    ...
    },
    {
      name: "Express",
      description:
        "Express.js es el framework backend más popular para Node. js, y es una parte extensa del ecosistema JavaScript. Está diseñado para construir aplicaciones web de una sola página, multipágina e híbridas, también se ha convertido en el estándar para desarrollar aplicaciones backend con Node.",
    },
    {
      name: "MongoDB",
      description:
    ...
    },
    {
      name: "React",
      description:
        "React (también llamada React.js o ReactJS) es un framework Javascript de código abierto diseñada para crear interfaces de usuario con el objetivo de facilitar el desarrollo de aplicaciones en una sola página. Es mantenido por Facebook y la comunidad de software libre.",
    },
    {
      name: "NextJS",
      description:
